...
function IA:CreateInspectFrame()
	...
	do --<< Equipment Slots >>--
		...
		for i, SlotName in T.pairs(Info.Armory_Constants.GearList) do
			...
			Slot.Gradation.Texture:SetTexture('Interface\\AddOns\\ElvUI_AdvancedArmory\\Media\\Textures\\Gradation')
...
function IA:Update_BG()
	...
	elseif E.db.sle.Armory.Inspect.Backdrop.SelectedBG == 'CUSTOM' then
		...
		self.BG:SetTexture(Info.Armory_Constants.BlizzardBackdropList[E.db.sle.Armory.Inspect.Backdrop.SelectedBG] or 'Interface\\AddOns\\ElvUI_AdvancedArmory\\Media\\Textures\\'..E.db.sle.Armory.Inspect.Backdrop.SelectedBG)
	end
end
